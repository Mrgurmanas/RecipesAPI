...
namespace RecipesAPI.Controllers
{
    ...
    public class SuppliersController : ControllerBase
    {
        ...
        public SuppliersController(ISuppliersRepository suppliersRepository, IMapper mapper, IRecipesRepository recipesRepository, IIngredientsRepository ingredientsRepository)
        {
